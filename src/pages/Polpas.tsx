  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="max-w-lg md:max-w-2xl lg:max-w-4xl mx-auto px-3 py-4">
        <img src={polpasFrutas} alt="Polpas de Frutas" className="w-full h-48 object-cover rounded-xl mb-4" />
        <h2 className="font-display text-2xl font-bold text-foreground mb-4">🍹 Polpas Naturais</h2>
              ...
              {(() => {
                ...
                return (
                  <motion.button
                    whileTap={{ scale: 0.9 }}
                    onClick={() => {
                      addItem({ id: p.id, name: p.nome, price: p.preco, variant: p.descricao || "", category: "Polpas Naturais" });
                      toast.success("Polpa adicionada! 🍹");
                    }}
